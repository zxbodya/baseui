...
import type { ColorTokensT, ComponentColorTokensT, SemanticColorTokensT, DeprecatedSemanticColorTokensT, AnimationT, BreakpointsT, BorderT, BordersT, FontT, GridT, LightingT, MediaQueryT, SizingT, TypographyT, ZIndexT } from '../themes/types';
export type { AnimationT, BreakpointsT, BorderT, BordersT, FontT as Font, GridT, LightingT, MediaQueryT, SizingT, TypographyT, ZIndexT, };
export declare type ColorsT = {} & ColorTokensT & ComponentColorTokensT & SemanticColorTokensT & DeprecatedSemanticColorTokensT;
export declare type ThemeT = {
    name: string;
