...
export declare type AlignT = keyof typeof ALIGN;
...
export declare type RadioGroupOverridesT = {
    RadioGroupRoot?: OverrideT<any>;
};
export declare type OverridesT = {} & RadioOverridesT & RadioGroupOverridesT;
export declare type DefaultPropsT = Partial<PropsT>;
...
export declare type RadioStateT = {
    isActive: boolean;
    isHovered: boolean;
};
...
export declare type StatefulRadioGroupPropsT = {
    overrides?: OverridesT;
