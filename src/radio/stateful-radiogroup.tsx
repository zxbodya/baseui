...
import {PropsT, StatefulRadioGroupPropsT} from './types';
// Styled elements

const StatefulRadioGroup = function(props: StatefulRadioGroupPropsT & Omit<PropsT, keyof StatefulRadioGroupPropsT>) {
