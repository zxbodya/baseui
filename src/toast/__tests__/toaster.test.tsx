...
describe('toaster', () => {
  ...
  describe('toaster methods', () => {
    ...
    test('toaster[show | update | clear]', () => {
      ...
      const MockNode1 = jest.fn().mockImplementation(() => 'Toast 1') as any;
      const MockNode2 = jest.fn().mockImplementation(() => 'Toast 2') as any;
      ...
      const MockNode3 = jest
        .fn()
        .mockImplementation(() => 'Toast updated') as any;
      const updatedProps = {
        children: <MockNode3 />,
        kind: KIND.positive,
      };
